...
const SECTION_MAP = {
  heroEmoji:   ['.hero-icon','.invitation-icon','.hero-emoji','.hero-image'],
  waitingMsg:  ['[data-i18n="waitingMsg"]','[data-i18n="bdWaitingMsg"]','.footer-msg','.waiting-msg'],
  heroText:    ['[data-i18n="eventLabel"]','[data-i18n="bdEventLabel"]','[data-i18n="gradEventLabel"]','[data-i18n="jubEventLabel"]','.event-label'],
  eventTitle:  ['.hero-title','.invitation-title','.event-name','h1'],
  dateLocation:['[data-i18n="detailsTitle"]','[data-i18n="dateLabel"]','.info-cards','.ic-wrap','.details-section'],
  schedule:    ['[data-i18n="programTitle"]','#program','.timeline-section','.program-section'],
  location:    ['[data-i18n="locationTitle"]','[data-i18n="venueLabel"]','.map-card','.location-section'],
  ...
  labels:      ['[data-i18n="countdownTitle"]','[data-i18n="gradCountdownTitle"]','.countdown','.cd-section'],
  ...
  message:     ['[data-tp="message"]','.greeting-text','.invitation-message','section.greeting-section','.greeting-section'],
