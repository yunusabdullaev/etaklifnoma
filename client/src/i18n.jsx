...
const translations = {
  uz: {
    ...
    'step3.heroSection': 'Yuqori belgi (shapka)',
    'step3.heroShow': "Ko'rsatish",
    'step3.heroHide': "Olib tashlash",
  ...
  ru: {
    ...
    'step3.heroSection': 'Верхний значок',
    'step3.heroShow': 'Показать',
    'step3.heroHide': 'Скрыть',
  ...
  qq: {
    ...
    'step3.heroSection': 'Joqarǵı belgi (shapka)',
    'step3.heroShow': 'Kórsetiw',
    'step3.heroHide': 'Alıp taslaw',
    'step3.emojiInputLabel': 'Emoji yamasa matn kiritiń',
    'step3.waitingSection': 'Kútiw xabarı',
    'step3.waitingLabel': 'Kútiw xabarı',
    'step3.heroTextSection': 'Joqarǵı jazıw matni',
  ...
  en: {
    ...
    'step3.heroSection': 'Hero icon (top)',
    'step3.heroShow': 'Show',
    'step3.heroHide': 'Remove',
