...
<main class="inv">
  ...
  <section class="hero bd-hero">
    ...
    <div class="hero-inner">
      {{#unless hideHeroEmoji}}<div class="bd-emoji" id="hero-emoji">{{heroEmoji|🎂}}</div>{{/unless}}
...
<main class="inv">
  ...
  <section class="hero">
    ...
    <div class="hero-inner">
      {{#unless hideHeroEmoji}}<div class="grad-emoji" id="hero-emoji">{{heroEmoji|🎓}}</div>{{/unless}}
...
<main class="inv">
  ...
  <section class="hero">
    ...
    <div class="hero-inner">
      {{#unless hideHeroEmoji}}<div class="jub-emoji" id="hero-emoji">{{heroEmoji|🎉}}</div>{{/unless}}
